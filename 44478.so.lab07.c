...
int main(int argc, char *argv[])
{
	...
	if (opt == 'r')
	{
		...
		//pobieranie informacji o plikach z rozszerzeniem .log
		hFindFile = FindFirstFileA("*.log", &findFileData);
		if (hFindFile == INVALID_HANDLE_VALUE)
		{
			_write(2, "Searching for latest file: error - file doesn't exist!", strlen("Searching for latest file: error - file doesn't exist!"));
			return 1;
		}
